...
public class ProviderTest extends AndroidTestCase {
    ...
    public void testGetType(){
        // content_authority = "content://com.example.android.moviedatabase/:
    ...
    private ContentValues getMovieContentValues(long genreID) {
        ContentValues value = new ContentValues();
        value.put(MovieContract.MovieEntry.COLUMN_GENRE, genreID);
        value.put(MovieContract.MovieEntry.COLUMN_NAME, TEST_MOVIE_NAME);
        value.put(MovieContract.MovieEntry.COLUMN_RELEASE_DATE, TEST_MOVIE_RELEASE_DATE);
        return value;
    }
